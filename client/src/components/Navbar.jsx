...
const Navbar = () => {
    ...
    return (
        <div>
            <div className="text-center text-white font-medium py-2 bg-gradient-to-r from-green-500 via-[#57C785] to-[#EDDD53]">
                <p>Exclusive Price Drop! Hurry, <span className="underline underline-offset-2">Offer Ends Soon!</span>
                </p>
            </div>
            <nav
                ...
                <div className="hidden sm:flex items-center gap-8">
                    ...
                    <div onClick={() => navigate("/cart")} className="relative cursor-pointer">
                        ...
                        <button
                            className="absolute -top-2 -right-3 text-xs text-white bg-primary w-[18px] h-[18px] rounded-full">3
                        </button>
                    </div>
                ...
                <div
                    ...
                    <NavLink to="/" className="block" onClick={() => setOpen(false)}>Offer</NavLink>
                    <NavLink to="/" className="block" onClick={() => setOpen(false)}>Contact</NavLink>
                    <NavLink to="/cart" className="block" onClick={() => setOpen(false)}>Cart</NavLink>
                    {user &&
